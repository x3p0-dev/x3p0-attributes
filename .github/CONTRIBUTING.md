...
The code for this package is handled via its [GitHub Repository](https://github.com/x3p0-dev/x3p0-attributes). You can open tickets, create patches, and send pull requests there.
...
There are instances where I opt for personal choices of my own. In terms of contributing, stick to the standard you're most familiar with. I'll make any adjustments later if the need arises.
